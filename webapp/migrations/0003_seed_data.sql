...
INSERT INTO Dinos (name, adult_class_name, sub_class_name, juv_class_name, hatch_class_name, diet, is_sandbox,
                   default_price, base_damage, alt_damage, health, weight, speed, ambush, sprint_seconds, base_bleed,
                   growth_minutes_adult, growth_minutes_sub, growth_minutes_juv, growth_minutes_hatch)
VALUES ("Diabloceratops", "DiabloAdultS", NULL, "DiabloJuvS", "DiabloHatchS", 5000, 0, FALSE, 350, NULL, 3250, 3250,
        31.6, NULL, 150, 18, 100, NULL, 80, 25),
       ("Dryosaurus", "DryoAdultS", NULL, "DryoJuvS", "DryoHatchS", 15000, 0, FALSE, 20, NULL, 500, 700, 41.5, NULL,
        250, NULL, 15, NULL, 15, 10),
       ("Gallimimus", "GalliAdultS", NULL, "GalliJuvS", "GalliHatchS", 7500, 0, FALSE, 150, NULL, 800, 1000, 48.6, NULL,
        400, NULL, 50, NULL, 40, 15),
       ("Maiasaura", "MaiaAdultS", NULL, "MaiaJuvS", "MaiaHatchS", 7500, 0, FALSE, 175, NULL, 2868, 2868, 44.6, NULL,
        180, NULL, 60, NULL, 50, 20),
       ("Pachycephalosaurus", "PachyAdultS", NULL, "PachyJuvS", "PachyHatchS", 7500, 0, FALSE, 350, NULL, 1300, 1300,
        40, NULL, 175, NULL, 60, NULL, 70, 20),
       ("Parasaurolophus", "ParaAdultS", NULL, "ParaJuvS", "ParaHatchS", 15000, 0, FALSE, 250, 750, 3600, 3600, 34.2,
        NULL, 250, NULL, 120, NULL, 60, 25),
       ("Triceratops", "TrikeAdultS", "TrikeSubS", "TrikeJuvS", "TrikeHatchS", 40000, 0, FALSE, 360, 850, 8200, 8300,
        25.34, NULL, 66, 25, 100, 200, 60, 30),

       ("Ankylosaurus", "Anky", NULL, "AnkyJuv", NULL, 30000, 0, TRUE, 1260, NULL, 5443, 5443, 19.3, NULL, 120, NULL,
        120, NULL, 120, NULL),
       ("Avaceratops", "Ava", NULL, "AvaJuv", NULL, 4000, 0, TRUE, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ("Camarasaurus", "Camara", NULL, NULL, NULL, 1000000, 0, TRUE, 750, 5150, 12000, 12000, 20.7, NULL, 70, NULL,
        NULL, NULL, NULL, NULL),
       ("Orodromeus", "Oro", NULL, NULL, NULL, 3000, 0, TRUE, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ("Psittacosaurus", "Taco", NULL, NULL, NULL, 1000, 0, TRUE, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ("Puertasaurus", "Puerta", NULL, "PuertaJuv", NULL, 10000000, 0, TRUE, 5000, NULL, 49895, 49895, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL),
       ("Shantungosaurus", "Shant", NULL, "ShantJuv", NULL, 80000, 0, TRUE, 250, 1100, 11793, 11793, 32.5, NULL, 46,
        NULL, 240, NULL, 120, NULL),
       ("Stegosaurus", "Stego", NULL, "StegoJuv", NULL, 40000, 0, TRUE, 1200, NULL, 4883, 4883, 26.3, NULL, 90, 30, 120,
        NULL, 120, NULL),
       ("Therizinosaurus", "Theri", NULL, "TheriJuv", NULL, 40000, 0, TRUE, 350, 700, 4536, 4536, 38.2, NULL, 65, NULL,
        120, NULL, 180, NULL),
