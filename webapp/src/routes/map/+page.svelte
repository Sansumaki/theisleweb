<script lang="ts">
    ...
    import pandasiaStore, {
        type IsleMap,
        type Location2D,
        type PoiLocation,
        type TeleportLocation
    } from "$lib/stores/pandasia.store.js";
    ...
    function LocationToLatLng(location: Location2D): number[] {
        return [-location.Location_Y / 1000, location.Location_X / 1000];
    }

    function LocationToString(location: Location2D): string {
